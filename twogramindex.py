...
class SearchEngineIndex:
    ...
    def process(self, webpage: Path, parent: Path) -> list:
        ...
        # Unique bigrams
        unique_bigrams = set(two_gram_tokens)

        # Word counts
        word_counts = {}
        for token in two_gram_tokens:
            word_counts[token] = word_counts.get(token, 0) + 1

        # Update tokens IDF and tokens dictionary
    ...
    def compute_pagerank(self):
        ...
        # Assign PageRank scores to webpages
